...
- The five allocation assets are USDG, TSLA, AAPL, NVDA and AMZN on Robinhood. Native ETH is gas-only; WETH is excluded. Read `docs/RWA_CHECK.md` for canonical routes, DEX-unit valuation, multiplier/pause semantics and issuer limitations. Never invent user target weights.
