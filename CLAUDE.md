...
Reuse applicable Ledger Agent Stack components; defer hardware testing/enrollment until arrival. Live integration/deployments/demo use mainnet only: Robinhood 4663 first, Base 8453 as the alternative. Keep local correctness tests, with no testnet or mock-stock demo milestone. Cloud LLM input and Privy's TEE are accepted. Preserve hackathon history and [AI/provenance records](docs/AI_USAGE.md).
