...
Existing selector loading/connection feedback and chart control feedback now use fixed bottom-center popups. Visible-versus-hidden feedback screenshots confirm the cards retain their position. Existing selector/control tests pass (49/49). Only CSS positioning/styling changed; no message lifecycle, modal, retry, wallet or execution behavior changed.
